...
#define USM_SEC_MODEL_NUMBER            3
    ...
    int             usm_set_usmStateReference_name(struct usmStateReference
                                                   *ref, char *name,
                                                   size_t name_len);
#ifdef __vms
    int             usm_set_usmStateRef_eng_id(struct
                                                        usmStateReference
                                                        *ref,
                                                        u_char * engine_id,
                                                        size_t
...
#endif
#ifdef __vms
    int             usm_set_usmStateRef_auth_pr(struct
                                                            usmStateReference
                                                            *ref,
                                                            oid *
                                                            auth_protocol,
...
#endif
#ifdef __vms
    int             usm_set_usmStateRef_auth_key(struct
                                                       usmStateReference
                                                       *ref,
                                                       u_char * auth_key,
                                                       size_t
...
#ifdef __vms
    int             usm_set_usmStateRef_priv_pr(struct
                                                            usmStateReference
                                                            *ref,
                                                            oid *
                                                            priv_protocol,
...
#ifdef _vms
    int             usm_set_usmStateRef_priv_key(struct
                                                       usmStateReference
                                                       *ref,
                                                       u_char * priv_key,
                                                       size_t
...
#endif
#ifdef __vms
    int             usm_set_usmStateRef_sec_level(struct
                                                        usmStateReference
                                                        *ref,
                                                        int sec_level);
#else
