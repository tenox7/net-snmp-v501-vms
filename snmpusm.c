...
int
#ifdef __vms
usm_set_usmStateRef_eng_id(struct usmStateReference *ref,
                                    u_char * engine_id,
...
int
#ifdef __vms
usm_set_usmStateRef_auth_pr(struct usmStateReference *ref,
                                        oid * auth_protocol,
...
int
#ifdef __vms
usm_set_usmStateRef_auth_key(struct usmStateReference *ref,
...
int
#ifdef __vms
usm_set_usmStateRef_priv_pr(struct usmStateReference *ref,
                                        oid * priv_protocol,
...
int
#ifdef __vms
usm_set_usmStateRef_priv_key(struct usmStateReference *ref,
...
int
#ifdef __vms
usm_set_usmStateRef_sec_level(struct usmStateReference *ref,
                                    int sec_level)
#else
...
{                               /* IN     - v3 Message flags.              */
...
#ifdef __vms
        if (usm_set_usmStateRef_sec_level(*secStateRef, secLevel) ==
            -1) {
#else
    ...
    if (secStateRef) {
#ifdef __vms
        if (usm_set_usmStateRef_auth_pr(*secStateRef,
                                                    user->authProtocol,
                                                    user->
                                                    authProtocolLen) ==
#else
...
#ifdef __vms
        if (usm_set_usmStateRef_auth_key(*secStateRef,
                                               user->authKey,
                                               user->authKeyLen) == -1) {
#else
...
#ifdef __vms
        if (usm_set_usmStateRef_priv_pr(*secStateRef,
                                                    user->privProtocol,
                                                    user->
                                                    privProtocolLen) ==
            -1) {
...
#ifdef __vms
        if (usm_set_usmStateRef_priv_key(*secStateRef,
                                               user->privKey,
                                               user->privKeyLen) == -1) {
#else
