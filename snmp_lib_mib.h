...
#ifdef __vms
    struct tree    *netsnmp_sprint_realloc_objid_tr(u_char ** buf,
                                                      size_t * buf_len,
                                                      size_t * out_len,
                                                      int allow_realloc,
                                                      int *buf_overflow,
...
#ifdef __vms
    int             sprint_realloc_object_id(u_char ** buf,
                                                     size_t * buf_len,
                                                     size_t * out_len,
                                                     int allow_realloc,
                                                     netsnmp_variable_list
...
#ifdef __vms
    void            print_oid_report_en_labeledoid(void);
#else
...
#ifdef __vms
    void            print_oid_report_en_symbolic(void);
#else
