 ...
 * In a Unix environment net-snmp-config.h is generated automatically.
 * This file was copied from NET-SNMP-CONFIG.H_IN in the net_snmp distribution.
 * To port to VMS, this file is edited by hand.
 */
...
#ifdef __vms
#define SYSTEM_INCLUDE_FILE "snmp_sys_generic.h"
#else
...
#ifdef __vms
#define MACHINE_INCLUDE_FILE "snmp_mach_generic.h"
#else
...
#ifdef __vms
/*
 * We only need one of conf, lib and share as they are all used together
 */
#define SNMPCONFPATH	"[]"
#else
#undef SNMPCONFPATH
...
#define NOTIFICATION_MIB		1,3,6,1,4,1,8072,4,0
#define NOTIFICATION_DOT_MIB		1.3.6.1.4.1.8072.4.0
#define NOTIFICATION_DOT_MIB_LENGTH	9
